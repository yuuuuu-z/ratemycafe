      ...
      <div className="container mx-auto py-12 px-4 md:px-8">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <p className=" leading-relaxed mb-4">
            RateMyCafe was born from a simple idea: that finding a great cafe
        ...
        <div className="mt-12 max-w-2xl mx-auto">
          ...
          <p className=" leading-relaxed mb-4">
            RateMyCafe is a simple, intuitive cafe rating system that empowers
            you to:
          </p>
        ...
        <div className="flex justify-center gap-8">
          ...
          <div className=" border-2 rounded-2xl shadow-md p-6 w-80">
            ...
            <div className="flex justify-around  text-lg rounded-lg ">
              <Link
                href="https://www.youtube.com/@ChuonSopheaktra-z2/videos"
                target="_blank"
              ...
              <Link
                href="https://www.facebook.com/sopheak.tra.35977897"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Facebook />
              ...
              <Link
                href="https://github.com/yuuuuu-z"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Github />
