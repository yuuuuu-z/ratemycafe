        ...
        <div className="container mx-auto py-12 px-4 md:px-8">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className=" leading-relaxed mb-4">
              ...
              that the best way to discover it is through honest,
              community-driven reviews.
            </p>
            <p className=" leading-relaxed">
              Our mission is to build a platform where cafe lovers can share
              their genuine experiences, from the perfect latte to the most
              comfortable study spot. We have created a space where you can rate
              cafes not just on the quality of their coffee, but on the
              ambiance, the service, and the value they offer.
            </p>
          </div>
          ...
          <div className=" mt-12 max-w-2xl mx-auto">
            ...
            <p className="leading-relaxed max-w-2xl mx-auto">
              We envision a world where the search for the perfect cafe is
              always successful. Our goal is to become the go-to platform for
              honest, transparent cafe discovery, fueled by the passion of our
              users.
            </p>
        ...
        <section className="mb-16 text-center">
          ...
          <ol className="list-decimal list-inside text-lg  mb-6 max-w-xl mx-auto text-left">
            ...
            <li className="mb-4">
              ...
              expand our reach and cover even more cofffe shop, ensuring that
              more user have access to accurate and reliable information.
            </li>
            <li className="mb-4">
